...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="tex-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div className="size-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                <MessageSquare className='text-base-content/60' />
              </div>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button type= 'submit'className="btn btn-primary w-full" disabled={isSigningUp}>
              {isSigningUp ? (
                <>
                  <Loader2 className='size-5 amimate-spin'/>
                  Loading...
                </>
              ):(
                "Create Account"
      ...
      {/* {right side} */}
      <AuthImagePattern title = 'Join our Community' subtitles = 'Connect with friends, share moments, and stay in touch with your loved ones'/>
    </div>
  )
}
